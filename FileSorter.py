...
directory = ['img', 'video', 'txt', 'pdf',
             'audio', 'rar']  # Different dir to create
...
while i < len(ls):
    ...
    elif ls[i].endswith(rar_ext):
        shutil.move(ls[i], os.getcwd()+'/rar')  # Move files to /rar
    i += 1
